        ...
        <div className="flex flex-col rounded-2xl border-2 border-brand-teal bg-brand-teal/[0.04] shadow-md">
            ...
            <div className="flex items-center justify-between">
              ...
              {isPro && (
                <span className="rounded-full bg-brand-teal px-2.5 py-0.5 text-xs font-semibold text-white">
                  {isAdminOverride ? "Complimentary" : "Current Plan"}
                </span>
              )}
            </div>
          ...
          <div className="flex flex-1 flex-col gap-4 p-6">
            ...
            <div className="mt-auto flex flex-col gap-2 pt-2">
              {isPro && isAdminOverride ? (
                <div className="rounded-xl border border-brand-teal/30 bg-brand-teal/5 px-4 py-3 text-center text-xs text-muted-foreground">
                  This plan was granted by the AppGap Admin at no charge. You
                  won't be billed while it's active.
                </div>
              ) : !isPro ? (
                <button
                  type="button"
