...
export const COLLEGE_ROUNDS = [
  ...
  // V9 expansion (+104). ROUND STRUCTURE ONLY, all `verified: false`. Same rule
  // as V2–V8: the loader writes these unverified (the matching engine ignores
  // unverified rounds), pending human confirmation before any becomes
  // `verified: true`. Names must match the V9 seeds in seed-colleges.mjs exactly.
  { name: "School of Visual Arts", verified: false, rounds: ["EA", "RD"] },
  {
    name: "Laguna College of Art and Design",
    verified: false,
    rounds: ["ROLLING"],
  },
  { name: "Shenandoah University", verified: false, rounds: ["ROLLING"] },
  { name: "LeTourneau University", verified: false, rounds: ["ROLLING"] },
  { name: "Trine University", verified: false, rounds: ["ROLLING"] },
  { name: "St Catherine University", verified: false, rounds: ["ROLLING"] },
  { name: "Regis College", verified: false, rounds: ["EA", "RD"] },
  { name: "Emmanuel College", verified: false, rounds: ["EA", "RD"] },
  { name: "Gannon University", verified: false, rounds: ["ROLLING"] },
  { name: "Mercyhurst University", verified: false, rounds: ["ROLLING"] },
  { name: "King's College", verified: false, rounds: ["ROLLING"] },
  { name: "Walsh University", verified: false, rounds: ["ROLLING"] },
  { name: "Benedictine University", verified: false, rounds: ["ROLLING"] },
  {
    name: "Saint Joseph's College of Maine",
    verified: false,
    rounds: ["ROLLING"],
  },
  { name: "Marymount University", verified: false, rounds: ["ROLLING"] },
  { name: "University of Mary", verified: false, rounds: ["ROLLING"] },
  { name: "Carroll College", verified: false, rounds: ["ROLLING"] },
  { name: "Saint Martin's University", verified: false, rounds: ["ROLLING"] },
  { name: "North Park University", verified: false, rounds: ["ROLLING"] },
  { name: "Grove City College", verified: false, rounds: ["EA", "RD"] },
  { name: "Messiah University", verified: false, rounds: ["EA", "RD"] },
  { name: "Gordon College", verified: false, rounds: ["EA", "RD"] },
  { name: "Bethel University", verified: false, rounds: ["ROLLING"] },
  { name: "Augsburg University", verified: false, rounds: ["ROLLING"] },
  {
  ...
  { name: "Concordia University-Irvine", verified: false, rounds: ["ROLLING"] },
  { name: "Lee University", verified: false, rounds: ["ROLLING"] },
  {
    name: "Trevecca Nazarene University",
    verified: false,
    rounds: ["ROLLING"],
  },
  { name: "Freed-Hardeman University", verified: false, rounds: ["ROLLING"] },
  { name: "Anderson University", verified: false, rounds: ["ROLLING"] },
  { name: "Erskine College", verified: false, rounds: ["ROLLING"] },
  { name: "William Carey University", verified: false, rounds: ["ROLLING"] },
  {
    name: "Mississippi Christian University",
    verified: false,
    rounds: ["EA", "RD"],
  },
  { name: "Oklahoma Baptist University", verified: false, rounds: ["ROLLING"] },
  {
    name: "Oklahoma Christian University",
    verified: false,
    rounds: ["ROLLING"],
  },
  { name: "John Brown University", verified: false, rounds: ["ROLLING"] },
  { name: "Evangel University", verified: false, rounds: ["ROLLING"] },
  { name: "Roberts Wesleyan University", verified: false, rounds: ["ROLLING"] },
  { name: "Houghton University", verified: false, rounds: ["ROLLING"] },
  { name: "University of Redlands", verified: false, rounds: ["EA", "RD"] },
  { name: "Moravian University", verified: false, rounds: ["EA", "RD"] },
  { name: "Lebanon Valley College", verified: false, rounds: ["EA", "RD"] },
  { name: "Elizabethtown College", verified: false, rounds: ["EA", "RD"] },
  { name: "Albright College", verified: false, rounds: ["ROLLING"] },
  { name: "Illinois College", verified: false, rounds: ["ROLLING"] },
  { name: "Marietta College", verified: false, rounds: ["ROLLING"] },
  { name: "Muskingum University", verified: false, rounds: ["ROLLING"] },
  { name: "Heidelberg University", verified: false, rounds: ["ROLLING"] },
  { name: "University of Mount Union", verified: false, rounds: ["ROLLING"] },
  { name: "Capital University", verified: false, rounds: ["ROLLING"] },
  { name: "Ashland University", verified: false, rounds: ["ROLLING"] },
  { name: "Adrian College", verified: false, rounds: ["ROLLING"] },
  { name: "Aquinas College", verified: false, rounds: ["ROLLING"] },
  { name: "Hamline University", verified: false, rounds: ["ROLLING"] },
  { name: "Buena Vista University", verified: false, rounds: ["ROLLING"] },
  { name: "Emory & Henry University", verified: false, rounds: ["ROLLING"] },
  { name: "Bridgewater College", verified: false, rounds: ["EA", "RD"] },
  { name: "University of Lynchburg", verified: false, rounds: ["EA", "RD"] },
  { name: "Newberry College", verified: false, rounds: ["ROLLING"] },
  { name: "Franklin Pierce University", verified: false, rounds: ["ROLLING"] },
  { name: "New England College", verified: false, rounds: ["ROLLING"] },
  { name: "Curry College", verified: false, rounds: ["ROLLING"] },
  { name: "Wilkes University", verified: false, rounds: ["ROLLING"] },
  { name: "Daemen University", verified: false, rounds: ["ROLLING"] },
  { name: "Utica University", verified: false, rounds: ["ROLLING"] },
  { name: "Manhattanville University", verified: false, rounds: ["ROLLING"] },
  { name: "University of Indianapolis", verified: false, rounds: ["ROLLING"] },
  { name: "Cumberland University", verified: false, rounds: ["ROLLING"] },
  { name: "Husson University", verified: false, rounds: ["ROLLING"] },
  { name: "Aurora University", verified: false, rounds: ["ROLLING"] },
  { name: "Pacific University", verified: false, rounds: ["EA", "RD"] },
  { name: "West Texas A & M University", verified: false, rounds: ["ROLLING"] },
  { name: "East Texas A&M University", verified: false, rounds: ["ROLLING"] },
  {
    name: "Texas A&M University-San Antonio",
    verified: false,
    rounds: ["ROLLING"],
  },
  { name: "Midwestern State University", verified: false, rounds: ["ROLLING"] },
  {
  ...
  { name: "Nicholls State University", verified: false, rounds: ["ROLLING"] },
  { name: "McNeese State University", verified: false, rounds: ["ROLLING"] },
  {
  ...
  { name: "Purdue University Northwest", verified: false, rounds: ["ROLLING"] },
  {
  ...
  { name: "Colorado Mesa University", verified: false, rounds: ["ROLLING"] },
  { name: "Western Colorado University", verified: false, rounds: ["ROLLING"] },
  {
  ...
  { name: "Edgewood University", verified: false, rounds: ["ROLLING"] },
  { name: "SUNY Old Westbury", verified: false, rounds: ["ROLLING"] },
  { name: "Clayton State University", verified: false, rounds: ["ROLLING"] },
  { name: "Columbus State University", verified: false, rounds: ["ROLLING"] },
  { name: "University of West Alabama", verified: false, rounds: ["ROLLING"] },
  {
    name: "Auburn University at Montgomery",
    verified: false,
    rounds: ["ROLLING"],
  },
  { name: "Arkansas Tech University", verified: false, rounds: ["ROLLING"] },
  {
  ...
  { name: "Delta State University", verified: false, rounds: ["ROLLING"] },
  {
